...
public class Main {
    ...
    static int[] memo= new int[20];//this will greatly increase speed and avoid kurudia computing the same thing
    ...
    public static int forCombinations(int steps){
        int m=0;
        int n=0;///
        int x=0;
        int permuts=0;
        while(n+2*m<=20 && (n*m)-m>=0){
            ...
            int permut=factorial(20)/factorial(n)*factorial(m);
